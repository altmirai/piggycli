...
tf = Mock()
tf.build.return_value = {'cluster_id': t.cluster_id,
                         'vpc_id': 'vpc-062a43279040c9896', 'instance_id': t.instance_id}
...
ssh_key.ssh_key_file = '/Users/kyle/GitHub/alt-piggy-bank/piggy-cli/tests/test_files/cluster-lbtkdldygfh/Piggy_SSH_Key_cf865bae.pem'
